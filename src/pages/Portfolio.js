        ...
        <div id="applications">
            ...
            <div class="card">
                <div id="passwordGenerator">
                    <h5>Password Generator <a href="https://github.com/christopherdoolhoff/module-3-challenge" target="_blank">
        GitHub
        </a></h5>
                ...
                <div id="codeQuiz">
                    <h5>Code Quiz <a href="https://github.com/christopherdoolhoff/code-quiz" target="_blank">
        GitHub
        </a></h5>
                ...
                <div id="workDayScheduler">
                    <h5>Work Day Scheduler <a href="https://github.com/christopherdoolhoff/work-day-scheduler" target="_blank">
        GitHub
        </a></h5>
                ...
                <div id="MediaSearch">
                    <h5>Media Search <a href="https://github.com/christopherdoolhoff/Media-search" target="_blank">
        GitHub
        </a></h5>
                ...
                <div id="HUBL">
                    <h5>HUBL <a href="https://github.com/christopherdoolhoff/PROJECT-2" target="_blank">
        GitHub
        </a></h5>
                ...
                <div id="noteTaker">
                    <h5>Note Taker <a href="https://github.com/christopherdoolhoff/Note-Taker" target="_blank">
        GitHub
        </a></h5>
